      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content shadow-lg border-0 rounded-4">
          <div className="modal-header border-bottom bg-light px-4 py-3">
            <h6 className="modal-title fw-bold mb-0">{t("recordCreditPayLater")}</h6>
            <button type="button" className="btn-close" onClick={onClose}></button>
          </div>
          <div className="modal-body p-4">
            <div className="mb-3">
              <label className="form-label fs-12 fw-medium text-muted">{t("customerAccount")}</label>
              <input type="text" className="form-control" defaultValue={customerName} />
            </div>
            <div className="mb-3">
              <label className="form-label fs-12 fw-medium text-muted">{t("dueDate")}</label>

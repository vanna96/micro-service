...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $rolePermissions = [
            'tenant-admin' => ['file_manager.view', 'file_manager.manage'],
            'catalog-manager' => ['file_manager.view', 'file_manager.manage'],
            'tenant-viewer' => ['file_manager.view'],
        ];
    ...
    public function down(): void
    {
        ...
        $permissionIds = DB::table('permissions')
            ->whereIn('name', ['file_manager.view', 'file_manager.manage'])
            ->pluck('id');

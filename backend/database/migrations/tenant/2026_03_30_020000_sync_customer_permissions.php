...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $rolePermissions = [
            'tenant-admin' => ['customers.view', 'customers.manage'],
            'catalog-manager' => ['customers.view', 'customers.manage'],
            'tenant-viewer' => ['customers.view'],
        ];
    ...
    public function down(): void
    {
        ...
        $permissionIds = DB::table('permissions')
            ->whereIn('name', ['customers.view', 'customers.manage'])
            ->pluck('id');
